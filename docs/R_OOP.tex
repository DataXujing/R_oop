...
## -1.30080 -0.68184 -0.37412 -0.28150  0.09321  0.64552
\end{verbatim}
...
## -1.7837 -0.7340  0.3075  0.6405  1.2717 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept)  0.04369    0.31364   0.139    0.892
## 
## Residual standard error: 0.9918 on 9 degrees of freedom
\end{verbatim}
...
\begin{verbatim}
## <environment: 0x000000001cd32420>
\end{verbatim}
...
## [16] "father"             "g"                  "genderFactor"      
## [19] "getShape"           "h"                  "i"                 
## [22] "manager"            "member"             "Member"            
## [25] "mother"             "n1"                 "n2"                
## [28] "plus"               "plus_one"           "r1"                
## [31] "s1"                 "son"                "student"           
## [34] "student.attend"     "student.default"    "student.exam"      
## [37] "student.homework"   "teacher"            "teacher.assignment"
## [40] "teacher.correcting" "teacher.default"    "teacher.lecture"   
## [43] "u1"                 "u2"                 "u3"                
## [46] "User"               "var"                "work"              
## [49] "x"                  "y"
\end{verbatim}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(pryr)}
\KeywordTok{system.time}\NormalTok{(b }\OperatorTok{%<d-%}\StringTok{ }\NormalTok{\{}\KeywordTok{Sys.sleep}\NormalTok{(}\DecValTok{1}\NormalTok{); }\DecValTok{1}\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x }\OperatorTok{%<a-%}\StringTok{ }\KeywordTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{x}
\end{Highlighting}
\end{Shaded}
